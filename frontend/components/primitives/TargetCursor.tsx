...
/**
 * GSAP-driven cursor: a phosphor dot that spins slowly and morphs into four
 * corner brackets when hovering any `.cursor-target` element. Brackets snap
 * to the target's bounding rect and track it.
 */
